...
try {
    ...
    $ouput = Less_Cache::Get(array($input => $options["sourceMapRootpath"]), $options);
    $css = file_get_contents($options["cache_dir"] . DIRECTORY_SEPARATOR . $ouput);
    $mtime = filemtime($options["cache_dir"] . DIRECTORY_SEPARATOR . $ouput);
